...
echo
echo "== Uji fungsional =="
for t in uji_apotek uji_apotek_kolam uji_kasir uji_rls uji_impor uji_penunjang uji_surat uji_periksa uji_antrean uji_kronis uji_kronis_pantau uji_laporan; do
  echo "-- $t"
